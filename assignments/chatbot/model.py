...
class ChatBotModel(object):
    ...
    def _inference(self):
        ...
        def sampled_loss(labels, logits):
            ...
            return tf.nn.sampled_softmax_loss(weights=tf.transpose(w),biases=b, labels=labels, inputs=logits, num_sampled=config.NUM_SAMPLES, num_classes=config.DEC_VOCAB)
